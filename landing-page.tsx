  ...
  return (
    <div className={`relative w-full h-screen bg-black text-white overflow-hidden ${manrope.className}`}>
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center z-10 w-full px-4">
        <h1 className="mx-auto mb-8 text-3xl sm:text-5xl md:text-6xl font-bold md:whitespace-nowrap text-balance max-w-5xl">
          One Entry, Endless Possibilities
        </h1>
        <h2 className="text-lg sm:text-xl mb-10 max-w-2xl mx-auto">
        </h2>
